...
/*createUserForm.addEventListener("submit", async (e) => {
    ...
    const email = createUserForm.email.value;
    const password = createUserForm.password.value;
    _auth1.login(_firebaseConfig.auth, email, password);
});
_auth.onAuthStateChanged(_firebaseConfig.auth, async (user)=>{
    if (user) {
        ...
        `;
        document.querySelector(".button-singOut").addEventListener("click", ()=>{
            _firebaseConfig.auth.signOut().then(()=>{
                location.reload();
            });
        });
    // ...
...
},{"firebase/auth":"drt1f","firebase/firestore":"cJafS","./firebaseConfig":"iGlw8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l8ReD","9jZEH"], "9jZEH", "parcelRequire5220")
