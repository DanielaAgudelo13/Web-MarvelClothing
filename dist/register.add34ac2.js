...
})({"flhZZ":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a6e950f9add34ac2";
...
},{}],"4VDBG":[function(require,module,exports) {
...
createUserForm.addEventListener("submit", async (e)=>{
    ...
    alert(userInfo.name);
    const newUser = await _auth.createUser(_firebaseConfig.auth, userInfo);
    await _auth.addUserToDatabase(_firebaseConfig.db, newUser.uid, userInfo);
    alert(`Bienvenido, ${name}`);
// window.location.href = "/products.html";
});

},{"./firebaseConfig":"iGlw8","./auth":"90aDw"}],"90aDw":[function(require,module,exports) {
...
async function validateAdmin(id) {
    const docRef = _firestore.doc(_firebaseConfig.db, "users", id);
    try {
        const docSnap = await _firestore.getDoc(docRef);
        const data = docSnap.data();
        const isAdmin = data.isAdmin;
        if (isAdmin) window.location.href = "/createProduct.html";
...
},{"firebase/auth":"drt1f","firebase/firestore":"cJafS","./firebaseConfig":"iGlw8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["flhZZ","4VDBG"], "4VDBG", "parcelRequire5220")

//# sourceMappingURL=register.add34ac2.js.map
